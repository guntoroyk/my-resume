    ...
    return (
        <>
            ...
            <div class="mt-10">
                ...
                <div class="md:flex">
                    <h2 class="italic text-base">Bachelor of Applied Science, Internet Engineering Technology, Ongoing, GPA: 3.70/4.00</h2>
                    <p class="ml-auto text-base">2018 - present</p>
                </div>
                <h2 class="italic text-base flex items-start">On going (5<span className="text-xs">th</span>-term of 6 term)</h2>
            </div>
            <div class="mt-10">
                <div class="md:flex">
                ...
                <div class="md:flex">
                    <h2 class="italic text-base">Vocational High School, Computer and Network Engineering, Grade: 86/100</h2>
